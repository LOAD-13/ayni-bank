    ...
    <div className="flex flex-col gap-5">
        ...
        >
          ...
          {fase === "en-vivo" && (
            <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-3 p-8">
              ...
              />
              <p
                className={`rounded-full px-4 py-1.5 text-[12.5px] font-semibold text-blanco ${
                  rostrosDetectados === 1
                    ? vivacidadConfirmada
                      ? "bg-exito"
                      : "bg-aviso-600 text-blanco"
                    : "bg-error"
                }`}
              >
      ...
      {fase === "en-vivo" && (
        <Boton
          onClick={tomarFoto}
          anchoCompleto
          disabled={rostrosDetectados !== 1 || !vivacidadConfirmada}
        >
